...
export default function productsRouter(router: express.Router) {
  ...
  router.get("/sellers/:sid", getSellerInStockProducts); //  ** Alejandra done ** gets all products a seller has listed, and searches by seller/user id
